...
for i in range(0,len(df_dailydemand)):
        ...
        f_name = "tier_2_21\\gh_site_" + str(df_dailydemand.iloc[i,0])+".csv"
        ...
        f_name = "tier_3_21\\gh_site_" + str(df_dailydemand.iloc[i,0])+".csv"
        ...
        f_name = "tier_4_21\\gh_site_" + str(df_dailydemand.iloc[i,0])+".csv"
